...
public:
    ...
    void movesInWith(Person &newRoomate) {
        ...
        if (!(roomie && newRoomate.roomie)) {
            ...
            cout << "You already have a roomie!\n";
        }
    }
...
int main() {
    ...
    */
    ...
    pI = &joe;
    *pI = 234;
    //  pI = &sal; const var cannot be pointed to with non const pointer
    *pI = 7623;

    const int *pcI;
    pcI = &joe;
    //*pcI = 234; cannot reassign const int
    pcI = &sal;
    //*pcI = 7623; cannot reassign const int

    //int* const cpI; initialized in the next line
    int *const cpI(&joe);
    //int* const cpI(&sal); initialized in the previous line
    //cpI = &joe; cannot modify const pointer
    *cpI = 234;
    //  cpI = &sal; cannot reassign  const pointer
    // *cpI = 7623; cannot modify int through const pointer

    //const int* const cpcI; initialized in the next line
    const int *const cpcI(&joe);
    //const int* const cpcI(&sal); initialized in the previous line
    //  cpcI = &joe; already initialized
    //  *cpcI = 234; cannot modify const var
    //  cpcI = &sal; cannot repoint const pointer
    // *cpcI = 7623; cannot modify const var
    ...
    PlainOldClassV2 *const ppoc2(&poc2);
